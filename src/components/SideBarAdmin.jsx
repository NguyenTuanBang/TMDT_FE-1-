...
export default function Sidebar() {
  ...
  const menu = [
    { name: "Dashboard", icon: Squares2X2Icon, link: "/admin/dashboard" },
    { name: "Quản lí người dùng", icon: UserGroupIcon, link: "/admin/users" },
    {
      name: "Quản lí cửa hàng",
      icon: BuildingStorefrontIcon,
      link: "/admin/stores",
    },
    { name: "Quản lí sản phẩm", icon: CubeIcon, link: "/admin/products" },
    {
      name: "Quản lí đơn hàng",
      icon: ClipboardDocumentListIcon,
      link: "/admin/orders",
    },
    { name: "Yêu cầu", icon: InboxIcon, link: "/admin/requests" },
  ];
