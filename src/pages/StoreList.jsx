...
const columns = [
  ...
  { name: "TÊN CỬA HÀNG", uid: "storename", width: "20%" },
  { name: "TÀI KHOẢN CHỦ", uid: "user" },
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex flex-wrap gap-3">
          ...
          >
            ...
            <SelectItem key="pending">Đang hoạt động</SelectItem>
            <SelectItem key="shipping">Chờ duyệt</SelectItem>
            <SelectItem key="completed">Ngưng hoạt động</SelectItem>
          </Select>
        </div>
      ...
      <StoreTable
        columns={columns}
        data={stores}
        // pagination={stores.length > 0 ? pagination : null}
        page={filters.page}
